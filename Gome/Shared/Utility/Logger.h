...
#define TRACE_LOCATION_PROCESS_THREAD_ID                                                                               \
    Shared::Utility::String(TEXT("PID: ") + Shared::Utility::ToString(::GetCurrentProcessId()) + TEXT(" TID: ") +      \
                            Shared::Utility::ToString(::GetCurrentThreadId()))
#define TRACE_LOCATION_FILE_LINE                                                                                       \
    Shared::Utility::ClampFileNameLength(TEXT(__FILE__), Shared::Utility::ToString(__LINE__), 50)
#define TRACE_LOCATION                                                                                                 \
    Shared::Utility::String(TRACE_LOCATION_PROCESS_THREAD_ID + TEXT(" ") + TRACE_LOCATION_FILE_LINE + TEXT("\t"))
#define TRACE(strn)                                                                                                    \
    Shared::Utility::Print<const ::TCHAR *>((TRACE_LOCATION + (Shared::Utility::StringStream() << strn).str()).c_str())
